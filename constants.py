...
#EXP_TYPE = 'low'  # uncomment this to run version with low probability of shock   # XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
EXP_TYPE = 'high'  # uncomment this to run version with high probability of shock
...
#-------------------------------------------
MAX_PRACTICE_TRIALS = 3
N_BLOCKS = 4    # Number of trial-blocks
MAX_N_TRIALS = 10    
#-------------------------------------------
